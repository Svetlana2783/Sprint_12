...
class TestYaScooterOrderPage:
    ...
    def test_order_page_first_name_input_incorrect_show_error_message(self, setup_method):
        ya_scooter_order_page = setup_method
    ...
    def test_order_page_last_name_input_incorrect_show_error_message(self, setup_method):
        ya_scooter_order_page = setup_method
    ...
    def test_order_page_address_input_incorrect_show_error_message(self, setup_method):
        ya_scooter_order_page = setup_method
    ...
    def test_order_page_subway_input_empty_show_error_message(self, setup_method):
        ya_scooter_order_page = setup_method
        ya_scooter_order_page.go_next()
    ...
    def test_order_page_telephone_number_input_incorrect_show_error_message(self, setup_method):
        ya_scooter_order_page = setup_method
    ...
    def test_order_page_go_to_choose_scooter_user_data_correct_open_about_rent(self, setup_method):
        ya_scooter_order_page = setup_method
    ...
    @pytest.mark.parametrize('data_set', ['data_set1', 'data_set2', 'data_set3'])
    def test_order_page_about_rent_input_correct_data_and_order_show_order_number(self, setup_method, data_set):
        ya_scooter_order_page = setup_method
    ...
    @pytest.mark.parametrize('data_set', ['data_set1', 'data_set2', 'data_set3'])
    def test_order_page_create_order_and_go_order_status(self, setup_method, data_set):
        ya_scooter_order_page = setup_method
        ya_scooter_order_page.fill_user_data(order_data.data_sets[data_set])
        ya_scooter_order_page.go_next()
        ya_scooter_order_page.fill_rent_data(order_data.data_sets[data_set])
